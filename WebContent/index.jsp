                    ...
                    <div class="form-bottom">
                        <form role="form" action="user.html" method="post" class="login-form">
                            ...
                            <div class="form-group">
                                ...
                                <span style="display: inline-block; width: 30%; text-align: right;"><img src="captcha.html" class="capimg"></span>
                                <img src="assets/img/refresh1.png" width="30px" height="30px" onclick="refreshcap()">
                            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="signform">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="sid" class="form-control" placeholder="请输入学号" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2">姓名:</label>
                        <div class="col-sm-10">
                            <input type="text" name="sname" class="form-control" placeholder="请输入姓名" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="password" class="form-control" placeholder="再输入一遍" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2">验证码:</label>
                        <div  class="col-sm-5">
                            <input type="text" name="captcha" class="form-control" placeholder="注册验证" required>
                        </div>
                        <span style="display: inline-block; width: 30%; text-align: right;"><img src="captcha.html" class="capimg"></span>
                        <img src="assets/img/refresh1.png" width="30px" height="30px" onclick="refreshcap()">
                    </div>
